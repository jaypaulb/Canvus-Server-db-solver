...
import (
	...
	"github.com/jaypaulb/canvus-server-db-solver/internal/commands"
...
var rootCmd = &cobra.Command{
	Use:   "canvus-server-db-solver",
	Short: "Canvus Server DB Solver - Asset Recovery Tool",
	Long: `Canvus Server DB Solver is a tool for identifying and restoring missing Canvus assets.
...
var runCmd = &cobra.Command{
	...
	Long:  `Execute the complete Canvus Server DB Solver workflow: discover missing assets, search backups, restore found assets, and generate reports.`,
	Run: func(cmd *cobra.Command, args []string) {
		runRunCommand()
	},
}
